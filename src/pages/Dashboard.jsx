            ...
            <main className="dashboard-main">
                <div className="dashboard-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '1rem' }}>
                    ...
                    <div className="flex items-center gap-4">
                        {/* Sync Now Button */}
                        <button
                            className="flex items-center gap-2 px-6 py-3 bg-gray-100 text-gray-400 font-bold rounded-xl border border-gray-200 cursor-not-allowed"
                            disabled
                        >
                            <Cloud size={20} />
                            Sync Now
                        ...
                        <div className="date-selector" style={{ position: 'relative', marginTop: 0 }}>
                    ...
                    <>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem', marginBottom: '2.5rem' }}>
                            ...
                            <div style={{ background: 'white', padding: '1.5rem', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-sm)', border: '1px solid var(--border-color)' }}>
                                ...
                                <div style={{ fontSize: '2.5rem', fontWeight: 800, color: '#059669', marginTop: '0.5rem' }}>92%</div>
                            </div>
                            ...
                            <div style={{ background: 'white', padding: '1.5rem', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-sm)', border: '1px solid var(--border-color)' }}>
                                ...
                                <div style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--text-dark)', marginTop: '0.5rem' }}>
                                    145<span className="text-gray-400 text-lg font-normal">/158</span>
                                </div>
